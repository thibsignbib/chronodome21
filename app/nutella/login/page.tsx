...
export default function NutellaLogin() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen overflow-hidden bg-white px-4">
        <div className="bg-white shadow-lg rounded-2xl p-8 w-full max-w-md">
            ...
            <input
                ...
                className="p-3 rounded-lg border border-gray-300 text-black placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-amber-400"
            />
            <input
                type="password"
